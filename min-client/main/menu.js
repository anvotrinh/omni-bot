function buildAppMenu(options = {}) {
  ...
  var tabTaskActions = [
    ...
    },
    {
      ...
      accelerator:
        getFormattedKeyMapEntry('duplicateTab') || 'shift+CmdOrCtrl+d',
      click: function (item, window, event) {
        if (!event.triggeredByAccelerator) {
    ...
    },
    {
      ...
      accelerator:
        getFormattedKeyMapEntry('addPrivateTab') || 'shift+CmdOrCtrl+p',
      click: function (item, window, event) {
        if (!event.triggeredByAccelerator) {
  ...
  var personalDataItems = [
    ...
    },
    {
      ...
      accelerator:
        getFormattedKeyMapEntry('showHistory') || 'Shift+CmdOrCtrl+h',
      click: function (item, window, event) {
        if (!event.triggeredByAccelerator) {
